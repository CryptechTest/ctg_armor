...
armor:register_armor("ctg_spacesuit:helmet_gold", {
	...
	groups = {armor_head=5, armor_heal=1, armor_use=spacesuit.armor_use-5, not_repaired_by_anvil=1,
		physics_speed=-0.02, physics_gravity=0.02, physics_jump=-0.02},
	armor_groups = {fleshy=7, radiation=15},
	damage_groups = {cracky=1, snappy=2, choppy=2, level=2},
	wear = 0,
...
armor:register_armor("ctg_spacesuit:chestplate_gold", {
	...
	groups = {armor_torso=8, armor_heal=1, armor_use=spacesuit.armor_use-5, not_repaired_by_anvil=1,
		physics_speed=-0.05, physics_gravity=0.03, physics_jump=-0.05},
	armor_groups = {fleshy=16, radiation=25},
	damage_groups = {cracky=1, snappy=2, choppy=2, level=2},
	wear = 0,
	wear_represents = "spacesuit_wear",
})
...
armor:register_armor("ctg_spacesuit:pants_gold", {
	...
	groups = {armor_legs=7, armor_heal=1, armor_use=spacesuit.armor_use-5, not_repaired_by_anvil=1,
		physics_speed=-0.04, physics_gravity=0.04, physics_jump=-0.05},
	armor_groups = {fleshy=14, radiation=15},
	damage_groups = {cracky=1, snappy=2, choppy=2, level=2},
	wear = 0,
	wear_represents = "spacesuit_wear",
})
...
armor:register_armor("ctg_spacesuit:boots_gold", {
	...
	groups = {armor_feet=4, armor_heal=1, armor_use=spacesuit.armor_use-5, not_repaired_by_anvil=1,
		physics_speed=-0.02, physics_gravity=0.02, physics_jump=-0.03},
	armor_groups = {fleshy=8, radiation=10},
	damage_groups = {cracky=1, snappy=2, choppy=2, level=2},
	wear = 0,
	wear_represents = "spacesuit_wear",
})