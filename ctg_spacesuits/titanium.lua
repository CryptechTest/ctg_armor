...
armor:register_armor("ctg_spacesuit:helmet_titanium", {
	...
	groups = {armor_head=5, armor_heal=1, armor_use=spacesuit.armor_use, not_repaired_by_anvil=1,
		physics_speed=-0.02, physics_gravity=0.02, physics_jump=-0.002},
...
armor:register_armor("ctg_spacesuit:chestplate_titanium", {
	...
	groups = {armor_torso=8, armor_heal=1, armor_use=spacesuit.armor_use, not_repaired_by_anvil=1,
		physics_speed=-0.05, physics_gravity=0.03, physics_jump=-0.005},
	armor_groups = {fleshy=25, radiation=15},
	damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	wear = 0,
	wear_represents = "spacesuit_wear",
})
...
armor:register_armor("ctg_spacesuit:pants_titanium", {
	...
	groups = {armor_legs=7, armor_heal=1, armor_use=spacesuit.armor_use, not_repaired_by_anvil=1,
		physics_speed=-0.04, physics_gravity=0.04, physics_jump=-0.005},
...
armor:register_armor("ctg_spacesuit:boots_titanium", {
	...
	groups = {armor_feet=4, armor_heal=1, armor_use=spacesuit.armor_use, not_repaired_by_anvil=1,
		physics_speed=-0.02, physics_gravity=0.02, physics_jump=-0.003},
	armor_groups = {fleshy=15, radiation=5},
	damage_groups = {cracky=2, snappy=1, choppy=1, level=3},
	wear = 0,
	wear_represents = "spacesuit_wear",
})