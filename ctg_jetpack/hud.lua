...
local update_hud = function(player, has_fuel, is_running, has_solar, armor_list, clear)
    ...
    elseif last_fuel_value + 0.000005 < factor_full and has_solar then
    ...
    player:hud_change(hud_data.fuel_fg, "scale", {
        x = factor_full * -7,
        y = 1
    })
...
ctg_jetpack.set_player_wearing2 = function(player, has_jetpack, has_fuel, is_active, has_solar, armor_list, armor_inv,
    ...
    local has_helmet = armor_inv and
                           (armor_inv:contains_item("armor", "spacesuit:helmet_base") or
                               armor_inv:contains_item("armor", "spacesuit:helmet") or
                               armor_inv:contains_item("armor", "ctg_spacesuit:helmet_titanium") or
                               armor_inv:contains_item("armor", "ctg_spacesuit:helmet_gold"))
